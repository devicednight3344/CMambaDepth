...
class Trainer:
    def __init__(self, options):
        ...
        if self.opt.dataset == "ddad":
            ...
            self.model_optimizer = optim.Adam(self.params)
        ...
        if self.opt.dataset == "ddad":
            train_dataset = self.dataset(4, self.opt.frame_ids, is_train=True, width=self.opt.width,
        ...
        if self.opt.dataset == "ddad":
            val_dataset = self.dataset(4, self.opt.frame_ids, is_train=False, width=self.opt.width,
                                        height=self.opt.height)
        else:
    ...
    def run_epoch(self):
        ...
        for batch_idx, inputs in enumerate(self.train_loader):
            ...
            # torchvision.utils.save_image(inputs[("color_MiS_aug", 0, 0)], "img/ddad_test.png")
    ...
    def load_model(self):
        ...
        if os.path.isfile(optimizer_load_path):
            ...
            # print(self.model_optimizer.state_dict()['param_groups'][2]['lr'])
        else:
