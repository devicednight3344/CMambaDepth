...
# CUDA_VISIBLE_DEVICES=0 python DDAD_eval_ppea.py --eval_mono --height 384 --width 640 --scales 0 --use_HAM --use_channel_mamba --use_channel_mamba_2 --num_workers 16 --dataset ddad --load_weights_folder models/CMambaDepth_ddad_2
# ddad数据集的路径通过datasets/ddad_dataset.py的'DDAD_TRAIN_VAL_JSON_PATH'修改
# networks/depth_decoder_msf.py里的downsample_size = [2, 1, 0, 1, 0, 1, 1]需要修改成downsample_size = [2, 1, 0, 1, 0, 1, 2]否则网络层对不上
