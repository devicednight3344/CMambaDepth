...
def test_simple(args):
    ...
    if args.use_channel_mamba:
        depth_decoder_path = os.path.join(model_path, "mamba_depth.pth")
    else:
    ...
    if args.use_channel_mamba:
        ...
        #     encoder.num_ch_enc, [0], use_channel_mamba=args.use_channel_mamba,
        #     use_channel_mamba_2=args.use_channel_mamba_2)
        depth_decoder = networks.DepthDecoder_MSF(
            encoder.num_ch_enc, [0], use_channel_mamba=args.use_channel_mamba,
            use_channel_mamba_2=args.use_channel_mamba_2, use_HAM=args.use_HAM, dataset=args.dataset)
    else:
        depth_decoder = networks.DepthDecoder_MSF(
            num_ch_enc=encoder.num_ch_enc, scales=range(1), use_channel_mamba=args.use_channel_mamba,
            use_channel_mamba_2=args.use_channel_mamba_2, use_HAM=args.use_HAM, dataset=args.dataset)
