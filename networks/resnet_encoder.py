...
def resnet_multiimage_input(num_layers, pretrained=False, num_input_images=1):
    ...
    if pretrained:
        ...
        # 从torchvision 0.15开始models.resnet里没有model_urls
        # 根据https://github.com/JiawangBian/sc_depth_pl/issues/61改成下面这样
        # ResNet = {18: models.ResNet18_Weights,
        #           34: models.ResNet34_Weights,
        #           50: models.ResNet50_Weights,
        #           101: models.ResNet101_Weights,
        #           152: models.ResNet34_Weights}
        # loaded = torch.hub.load_state_dict_from_url(ResNet[num_layers].IMAGENET1K_V1.url)
